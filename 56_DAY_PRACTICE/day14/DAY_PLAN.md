...
2. Write one join query
3. Write one window function query
4. Debug one duplicate-row issue from wrong join
5. Explain where BigQuery fits in AI app architecture
